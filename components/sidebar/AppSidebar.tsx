...
const SideCart = () => {
  ...
  const shipping = mounted
    ? subtotal >= FREE_SHIPPING_THRESHOLD
      ...
      : SHIPPING_COST
    : 0;
  const finalTotal = mounted ? subtotal + shipping : 0;
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={clsx(
            "absolute right-0 top-0 h-full w-full sm:w-[400px] bg-gradient-to-b from-background via-background/95 to-background shadow-2xl border-l border-white/10 transition-transform duration-300 ease-out",
        ...
        >
          ...
          {/* Free Shipping */}
          {mounted && subtotal < FREE_SHIPPING_THRESHOLD && (
