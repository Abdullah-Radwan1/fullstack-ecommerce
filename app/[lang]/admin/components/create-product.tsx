    ...
    <div className="max-w-xl mx-auto mt-10 p-6 border-2 shadow-md rounded-md gray-800">
      ...
      <form onSubmit={handleSubmit}>
          ...
          >
            ...
            {isGeneratingDescription && (
              <span className="text-xs text-muted-foreground ml-2 flex gap-2 ">
                <h6 className="text-sm font-bold bg-gradient-to-r from-my-main  to-my-secondary  bg-clip-text text-transparent">
                  {ar
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="w-full bg-gradient-to-r from-my-main  to-my-secondary  hover:opacity-90 transition text-white py-2 rounded flex items-center justify-center gap-2"
        >
