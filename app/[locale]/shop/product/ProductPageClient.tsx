...
import type { selectedprismaProduct } from "@/lib/types";

type ProductWithCreatedAt = selectedprismaProduct & { createdAt: Date };
...
export default function ProductPageClient({
  ...
  relatedProducts: ProductWithCreatedAt[];
}) {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="flex flex-col space-y-6 h-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[t("freeShipping"), t("daysReturn"), t("warranty")].map(
                (label, idx) => {
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    { label: t("status"), value: t("inStock") },
                    {
                      label: t("added"),
                      value: formattedDate(product.createdAt, {
                        year: "numeric",
                        month: "short",
                        day: "numeric",
                      }),
