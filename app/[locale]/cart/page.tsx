...
const Page = () => {
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-6">
        <div className="text-center space-y-6 max-w-md">
          ...
          <p className="text-muted-foreground text-lg">{t("emptyMessage")}</p>
  ...
  return (
    <div
      className={`min-h-screen bg-background p-4 md:p-8 ${locale === "ar" ? "rtl" : "ltr"}`}
    >
      {/* background blobs */}
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-4xl font-bold">{t("cartTitle")}</h1>
            <p className="text-muted-foreground mt-2">{t("cartSubtitle")}</p>
          </div>
          ...
          <Card className="lg:col-span-2 border-border/40 bg-card/50 backdrop-blur-sm shadow-xl overflow-hidden">
            ...
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-2xl font-bold">{t("selectedProducts")}</h2>
              </div>
            </CardHeader>
